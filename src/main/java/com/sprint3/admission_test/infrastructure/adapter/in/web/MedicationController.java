...
public class MedicationController {
    ...
    @PostMapping
    public ResponseEntity<Medication> createMedication(@Valid @RequestBody MedicationRequestDto requestDto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(medicationUseCase.createMedication(requestDto));
    }}
